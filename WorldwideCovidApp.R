...
setwd("~/Documents/Masters/Summer 2021/STAT 824/Week 8/Final Project/COVIDDashboard")

file <- paste("covid_", Sys.Date(), ".csv", sep = "")
url <- "https://raw.githubusercontent.com/owid/covid-19-data/master/public/data/owid-covid-data.csv"

if(!file.exists(file)){
    download.file(url, file)
} 
covidData <- read.csv(file, header = T)[,c(2,3,4,5,6,8,9)]
